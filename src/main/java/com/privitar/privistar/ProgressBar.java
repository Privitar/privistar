...
import com.privitar.privistar.settings.AppSettingsState;
...
public class ProgressBar extends BasicProgressBarUI {
    ...
    protected void paintIndeterminate(Graphics g2d, JComponent c) {
        ...
        LinearGradientPaint baseRainbowPaint = new LinearGradientPaint(0, JBUI.scale(2), 0, h - JBUI.scale(6),
                new float[]{ONE_OVER_SEVEN * 1, ONE_OVER_SEVEN * 2, ONE_OVER_SEVEN * 3, ONE_OVER_SEVEN * 4, ONE_OVER_SEVEN * 5, ONE_OVER_SEVEN * 6,
                        ONE_OVER_SEVEN * 7},
...
//        g.setPaint(baseRainbowPaint);
        ...
        getIcon().paintIcon(progressBar, g, offset2 - JBUI.scale(10), -JBUI.scale(6));
    ...
    private Icon getIcon() {
        PrivistarIcon privistarIcon = AppSettingsState.getInstance().getPrivistarIcon();
        return velocity >= 0 ? privistarIcon.getForwardIcon() : privistarIcon.getBackwardIcon();
    }
...
//        g2.setColor(progressBar.getForeground());
        ...
        getIcon().paintIcon(progressBar, g2, amountFull - JBUI.scale(10), -JBUI.scale(6));
